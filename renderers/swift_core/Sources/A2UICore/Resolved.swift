...
/// A marker protocol for resolved A2UI types that are safe to pass across threads.
...
extension Resolved where Self: Equatable {
  /// Default implementation of isEqual(to:) using the type's Equatable conformance.

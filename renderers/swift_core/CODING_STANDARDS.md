...
- **Directory Structure:** All sources must reside under `Sources/<TargetName>` and all test
  files under `Tests/<TargetName>Tests` following standard Swift Package Manager conventions.

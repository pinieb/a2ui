...
# Deploys the A2UI v0.9 Demo agent to Cloud Run from source.
...
# Update the service to set the AGENT_URL environment variable so the agent
# advertises its public URL in its AgentCard.

 ...
 *   https://github.com/CopilotKit/private_a2ui_demo/blob/main/packages/a2ui-renderer/src/theme/viewer-theme.ts
 *
 * This is the theme used by A2UIViewer on the production composer gallery.
 * The original uses v0_8.Styles.merge() for "Light" element variants —
 * replaced here with plain object spreads (identical behavior).
 */

// =============================================================================
// Element class maps (for markdown rendering and form elements)
// =============================================================================

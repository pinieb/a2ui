...
/// Evaluator for the "allOf" keyword in JSON Schema.
public struct AllOfEvaluator: KeywordEvaluator {
  private let subschemas: [SchemaNode]

  /// Initializes the AllOfEvaluator compiling each subschema in the allOf array.
  public init(
    data: JSONValue,
  ...
  public func evaluate(
    ...
    if isValid {
      ...
      return .failure(
        error: "Instance did not validate against all subschemas in 'allOf'.",

...
/// Evaluator for the "maximum" keyword in JSON Schema.
public struct MaximumEvaluator: KeywordEvaluator {
  private let limit: JSONValue

  /// Initializes the MaximumEvaluator.
  /// - Parameter limitValue: The JSONValue containing the maximum limit.
  ...
  public func evaluate(instance: JSONValue, context: ValidationContext) -> ValidationResult {
    ...
    return .failure(
      error: "Instance value is greater than maximum limit."
    )
  }
}

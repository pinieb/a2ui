...
/// Evaluator for the "minimum" keyword in JSON Schema.
public struct MinimumEvaluator: KeywordEvaluator {
  private let limit: JSONValue

  /// Initializes the MinimumEvaluator.
  /// - Parameter limitValue: The JSONValue containing the minimum limit.
  ...
  public func evaluate(instance: JSONValue, context: ValidationContext) -> ValidationResult {
    ...
    return .failure(
      error: "Instance value is less than minimum limit."
    )
  }
}

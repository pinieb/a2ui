...
`,
  ...
  },
  {
    ...
    schemaPath,
    promptText:
      'Generate a JSON message containing a surfaceUpdate for a login form. It should have a "Login" heading, two text fields for username and password (bound to /login/username and /login/password), a checkbox for "Remember Me" (bound to /login/rememberMe), and a "Sign In" button. The button should trigger a \'login\' action, passing the username, password, and rememberMe status in the dynamicContext.',
    matchers: [
      new MessageTypeMatcher('surfaceUpdate'),
  ...
  },
  {
    ...
    schemaPath,
    promptText:
      'Generate a JSON message with a \'beginRendering\' property. This message tells the client where to start rendering the UI. Set the UI root to a component with ID "mainLayout".',
...
`,
  ...
  },
  {
    ...
    schemaPath,
    promptText:
      'Generate a JSON message with a surfaceUpdate property for a survey form. It should have a \'Heading\' "Customer Feedback". Then a \'MultipleChoice\' question "How would you rate our service?" with options "Excellent", "Good", "Average", "Poor". Then a \'CheckBox\' section for "What did you like?" with options "Product Quality", "Price", "Customer Support". Finally, a \'TextField\' with the label "Any other comments?" and a \'Button\' labeled "Submit Feedback".',
    matchers: [
      new MessageTypeMatcher('surfaceUpdate'),
  ...
  },
  {
    ...
    schemaPath,
    promptText:
      'Generate a JSON message with a surfaceUpdate property for a simple dashboard. It should have a \'Heading\' "Sales Dashboard". Below, a \'Row\' containing three \'Card\'s. The first card has a \'Text\' "Revenue" and another \'Text\' "$50,000". The second card has "New Customers" and "1,200". The third card has "Conversion Rate" and "4.5%".',
    matchers: [
      new MessageTypeMatcher('surfaceUpdate'),
  ...
  },
  {
    ...
    schemaPath,
    promptText:
      "Generate a JSON message with a surfaceUpdate property for a contact card. It should be a 'Card' with a 'Row'. The row contains an 'Image' (as an avatar) and a 'Column'. The column contains a 'Text' for the name \"Jane Doe\", a 'Text' for the email \"jane.doe@example.com\", and a 'Text' for the phone number \"(123) 456-7890\". Below the main row, add a 'Button' labeled \"View on Map\".",
    matchers: [
      new MessageTypeMatcher('surfaceUpdate'),
      new SurfaceUpdateSchemaMatcher('Column'),
      new SurfaceUpdateSchemaMatcher('Image'),
  ...
  },
  {
    ...
    schemaPath,
    promptText:
      'Generate a JSON message with a surfaceUpdate property for a checkout page. It should have a \'Heading\' "Checkout". Create a \'Column\' for "Shipping Information" with \'TextField\'s for "Full Name" and "Address". Create another \'Column\' for "Payment Information" with \'TextField\'s for "Card Number" and "Expiry Date". Add a \'Divider\'. Show an order summary with a \'Text\' component: "Total: $99.99". Finally, a \'Button\' labeled "Place Order".',
    matchers: [
      new MessageTypeMatcher('surfaceUpdate'),
